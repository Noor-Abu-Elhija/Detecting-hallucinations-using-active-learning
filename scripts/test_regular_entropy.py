...
# This script tests sequence-level entropy computation for LLM generations,
# showing how diverse or confident the model's sampled completions are.
...
def main():
    """Run entropy test for a given prompt using a chosen LLM model."""
    args = get_args()
